...
gulp.task('clear', async function() {
	return cache.clearAll(); // Удаляем папку dist перед сборкой
});
...
gulp.task('watch', function() {
	...
	gulp.watch('app/css/*.css', gulp.parallel('code_css')); // Наблюдение за HTML файлами в корне проекта
