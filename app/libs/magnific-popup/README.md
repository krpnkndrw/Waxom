...
- Source files are in folder [img/](https://github.com/dimsemenov/Magnific-Popup/tree/master/src). They include [Sass CSS file](https://github.com/dimsemenov/Magnific-Popup/blob/master/img/css/main.scss) and js parts (edit them if you wish to submit commit). 
...
- Run `grunt watch` to automatically rebuild script when you change files in `img/` or in `website/`.
